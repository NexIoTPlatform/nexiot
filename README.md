...
- **开源协议**：本项目遵循 Apache-2.0 开源协议，允许个人及企业在遵守协议与本声明的前提下进行内部使用、学习研究和二次开发
- **保留声明**：使用、修改、集成或部署本项目时，必须保留项目来源、版权信息、License、NOTICE、代码注释及相关声明，不得删除、篡改、遮蔽或弱化
- **禁止行为**：严禁去标识化、冒名发布、二次开源、二次分发、转授权，或将本项目内容包装为自有项目/产品对外传播
...
本项目遵循 **Apache-2.0 开源协议**。个人及企业可在遵守 Apache-2.0 协议和本声明的前提下，将本项目用于企业内部部署、学习研究、系统集成和二次开发。

任何使用、复制、修改、集成、部署或分发行为，均必须完整保留项目来源、版权信息、License、NOTICE、代码注释及 README 中的相关声明，**不得删除、篡改、遮蔽或弱化上述信息**。

严厉禁止在未完整保留来源和声明的情况下使用本项目内容，禁止对本项目源码、文档、页面、示例、图片等内容进行去标识化、冒名发布、二次开源、二次分发、转授权，或包装为自有项目/产品对外传播。

违反 Apache-2.0 协议及本声明，或通过删除来源、移除注释、篡改声明、冒名发布、二次开源分发等方式侵害本项目权益的，我方将依据《著作权法》《民法典》及相关协议约定，**依法追究相关法律责任与经济赔偿责任**。
