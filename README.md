...
| HTTP 接入      | HTTP / HTTPS API           | 第三方业务系统、软件平台、Web 服务主动推送设备数据，或平台间云云对接。                | ✅ 开源已支持 | 适合系统集成；非标准字段可做接口映射和数据转换。                          |
| TCP 直连       | TCP 私有协议设备                 | DTU、网关、JT/T 808 车载定位、DL/T 645 电表、厂商私有协议设备主动连接平台。             | ⭐ 商业已支持 | 可适配二进制、16 进制、JSON、自定义粘包拆包和命令响应匹配。                 |
| UDP 直连       | UDP 短报文设备                  | 定位设备、低功耗设备、简单传感器、短报文上报设备。                            | ⭐ 商业已支持 | 适合轻量上报场景；复杂业务建议评估是否改 MQTT/TCP。                    |
| 工业协议         | Siemens S7                 | 西门子 S7 PLC，产线设备、设备控制柜、工业控制系统。                        | ⭐ 商业已支持 | 支持点位读写、轮询采集；需提供 PLC 地址、Rack/Slot、点位表。             |
| 工业协议         | OPC UA                     | OPC UA Server、工业网关、PLC、SCADA/DCS 数据服务。               | ⭐ 商业已支持 | 支持节点浏览、读写、订阅和安全策略；需确认证书/账号/节点命名空间。                |
| 工业协议         | 新 Modbus 工业采集              | 工业现场 Modbus TCP/RTU 设备，需按端点、点位、采集组统一管理。              | ⭐ 商业已支持 | 比普通 Modbus 更适合工业点位管理、采集组、运行状态和写入控制。               |
| 工业协议         | EtherNet/IP                | Rockwell / Logix PLC 及 EtherNet/IP 现场设备。             | 🔧 内测中  | 支持 Tag 读写；结构体、数组等复杂 Tag 可按现场点位表适配。                |
| 工业协议         | BACnet/IP                  | 楼宇自控、空调、照明、BA 设备、园区机电设备。                             | 🔧 内测中 | 支持对象属性读写；需提供设备实例、对象类型、对象实例和属性清单。                  |
| 工业协议         | Beckhoff ADS               | 倍福 PLC、TwinCAT 控制系统。                                 | 🔧 内测中 | 支持符号变量读写、订阅；需确认 AMS Net ID 和变量表。                  |
| 工业协议         | Mitsubishi MC              | 三菱 PLC。                                              | 🔧 内测中 | 支持 D、M、X 等地址点位；需提供帧格式、站号和点位表。                     |
| 工业协议         | Omron FINS                 | 欧姆龙 PLC。                                             | 🔧 内测中 | 支持 DM、CIO、W、H 等地址点位；需确认节点号和点位表。                   |
| 运营商云平台       | CTWing / 天翼物联 CT-AIoT      | 电信 NB-IoT 设备、已在天翼物联平台管理的设备、希望复用公共产品的项目。              | ⭐ 商业已支持 | 公共产品库可选 **2913 款公共产品**；支持产品/设备管理、数据上报、命令下发。       |
| 运营商云平台       | OneNET / 移动物联网平台           | 已接入中国移动 OneNET 的设备和项目。                               | ⭐ 商业已支持 | 支持平台对接、设备数据接入；不同 OneNET 产品形态需按接口版本适配。             |
| 视频安防         |  GB28181                   | 国标摄像机、NVR、视频平台、园区/工地/安防视频项目。                         | ⭐ 商业已支持 | 支持 GB28181 视频体系；不同平台、通道和录像能力按现场环境适配。              |
| 视频安防         | 海康 ISC                     | 海康 iSecure Center 综合安防平台。                            | ⭐ 商业已支持 | 支持平台设备同步和导入；需提供平台地址、认证信息和权限。                      |
| 视频安防         | 大华 ICC                     | 大华智能物联综合管理平台。                                        | ⭐ 商业已支持 | 支持平台设备同步和导入；需提供平台地址、认证信息和权限。                      |
| 视频安防         | ONVIF / RTSP               | 局域网摄像机、RTSP 视频流、本地网络摄像头。                             | 🔧 项目适配 | 可发现、导入或直接配置流地址；不同厂商鉴权和码流路径可适配。                    |
| 视频安防         | 海康 / 大华 Direct SDK Gateway | 无上级平台、需要直连摄像机或 NVR 的海康/大华项目。                         | 🔧 项目适配 | 通过独立 SDK 网关接入；需按设备型号和 SDK 能力确认。                   |
| 视频安防         | 萤石云 / 乐橙云                  | 云摄像机、门店/连锁/轻量安防项目。                                   | 🔧 项目适配 | 适合已有厂商云账号的项目；受厂商开放接口能力影响。                         |
| 第三方平台        | TTLock / 通通锁               | 智能门锁、公寓门锁、酒店门锁、门禁锁。                                  | 🔧 项目适配 | 支持门锁、用户、密码、卡、指纹、开锁记录；其他门锁云平台可评估适配。                |
| 自定义扩展        | 协议脚本 / WebIDE 调试           | 协议不标准、需要现场联调、客户只有报文样例或协议文档的设备。                       | ✅ 开源已支持 | 适合 MQTT/HTTP/Modbus 等开源能力内的自定义解析；TCP/UDP 直连需商业能力。 |
